...
export const serviceCards = [
  {
    image: '/card1 (1).png',
    icon: <RedeemIcon sx={{ color: '#2196f3', fontSize: 32 }}/>, // MUI icon name
    title: 'Seasonal offers and regular discounts',
    description: 'Regular offers and seasonal discounts give you more for less.'
  },
  {
    image: '/card2.png',
    icon: <PinDropIcon sx={{ color: '#2196f3', fontSize: 32 }}/>, // MUI icon name
  ...
  {
    image: '/card3.png',
    icon:  <PaidIcon sx={{ color: '#2196f3', fontSize: 32 }}/>, // MUI icon name
